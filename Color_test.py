import cv2
import numpy as np
bright = cv2.imread('Test.jpg')
dark = cv2.imread('Test.jpg')
...
cv2.namedWindow("Result BGR",0)
cv2.namedWindow("Result HSV",0)
cv2.namedWindow("Result YCB",0)
cv2.namedWindow("Result LAB",0)
